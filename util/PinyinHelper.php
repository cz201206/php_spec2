<?php
class PinyinHelper {//注意仅支持：GBK，故传入参数前须转码
    /**
    ...
    public function getChineseSpells($chinese, $delimiter = '', $first=0){
        ...
        $pinyin = iconv("gb2312","UTF-8", implode($delimiter, $result));
        return $pinyin;
    }

    public function deleteCode($str){
        //中文标点
    ...
    public function getChineseSpells_deleteCode($chinese, $delimiter='', $first=0){
        return  $this->deleteCode($this->getChineseSpells($chinese, $delimiter, $first));
    }
